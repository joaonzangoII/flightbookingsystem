...
public class RouteManager {
    ...
    public static String GET_INITIAL_DATA = API_URL + "/initial-data";
    public static String FIND_FLIGHTS = API_URL + "/find-flights";
    public static String GET_TIMETABLE = API_URL + "/flights-timetable";
    public static String GET_TRAVEL_CLASSES = API_URL + "/travel-classes";
    ...
    public static String ADD_UPDATE_DRINK = API_URL + "/add-update-drink";
    public static String ADD_UPDATE_FOOD = API_URL + "/add-update-food";
